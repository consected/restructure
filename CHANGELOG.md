...
- [Built] and tested release-ready version '8.2.81'
- [new] version created 8.2.82
- [Built] and tested release-ready version '8.2.82'
- [Update] CHANGELOG.md
- [new] version created 8.2.93
- [Built] and tested release-ready version '8.2.93'
- [new] version created 8.2.94
- [Built] and tested release-ready version '8.2.94'
- [new] version created 8.2.102
- [Built] and tested release-ready version '8.2.102'
- [new] version created 8.2.103
- [Built] and tested release-ready version '8.2.103'
- [new] version created 8.2.104
- [Built] and tested release-ready version '8.2.104'
- [new] version created 8.2.113
- [Built] and tested release-ready version '8.2.113'
- [new] version created 8.2.114
- [Built] and tested release-ready version '8.2.114'
- [Updated] CHANGELOG
- [new] version created 8.4.2
- [Built] and tested release-ready version '8.4.2'
- [Built] and tested release-ready version '8.4.2' - dev repo
- [Updated] CHANGELOG
- [Updated] CHANGELOG
- [new] version created 8.4.3
- [Built] and tested release-ready version '8.4.3'
- [Built] and tested release-ready version '8.4.3' - dev repo
- [Fixed] CHANGELOG
- [Updated] CHANGELOG
- [Fixed] test bug
- [new] version created 8.4.4
- [Built] and tested release-ready version '8.4.4'
- [Built] and tested release-ready version '8.4.4' - dev repo
- [Fixed] CHANGELOG
- [Updated] gems
- [Updated] CHANGELOG
- [new] version created 8.4.5
- [Built] and tested release-ready version '8.4.5'
- [Built] and tested release-ready version '8.4.5' - dev repo
- [Updated] CHANGELOG
- [Updated] CHANGELOG
- [new] version created 8.4.6
- [Built] and tested release-ready version '8.4.6'
- [Built] and tested release-ready version '8.4.6' - dev repo
- [new] version created 8.4.10
- [Built] and tested release-ready version '8.4.10'
- [Built] and tested release-ready version '8.4.10' - dev repo
- [Updated] CHANGELOG
- [Updated] CHANGELOG
- [new] version created 8.5.1
- [Built] and tested release-ready version '8.5.1'
- [Built] and tested release-ready version '8.5.1' - dev repo
- [Bring] up to date from upstream
- [Updated] CHANGELOG and bumped version
- [Updated] CHANGELOG
- [new] version created 8.6.2
- [Built] and tested release-ready version '8.6.2'
- [Built] and tested release-ready version '8.6.2' - dev repo
- [Updated] CHANGELOG
- [Updated] CHANGELOG
- [new] version created 8.6.3
- [Built] and tested release-ready version '8.6.3'
- [Built] and tested release-ready version '8.6.3' - dev repo
- [Updated] CHANGELOG
- [new] version created 8.6.4
- [Built] and tested release-ready version '8.6.4'
- [Built] and tested release-ready version '8.6.4' - dev repo
- [Updated] CHANGELOG
- [Updated] CHANGELOG
- [new] version created 8.6.5
- [Built] and tested release-ready version '8.6.5'
- [Built] and tested release-ready version '8.6.5' - dev repo
- [Updated] CHANGELOG
- [new] version created 8.6.6
- [Built] and tested release-ready version '8.6.6'
- [Built] and tested release-ready version '8.6.6' - dev repo
- [Fixed] job failure notifications
- [Updated] CHANGELOG
- [new] version created 8.6.7
- [Built] and tested release-ready version '8.6.7'
- [Built] and tested release-ready version '8.6.7' - dev repo
- [Added] set_item_flag options to add_flags and remove_flags
- [Updated] CHANGELOG
- [new] version created 8.6.8
- [Built] and tested release-ready version '8.6.8'
- [Built] and tested release-ready version '8.6.8' - dev repo
- [Added] index to tracker_history to improve performance
- [Dumped] latest DB structure
...
- [Updated] CHANGELOG
- [Updated] CHANGELOG
- [new] version created 8.6.9
- [Built] and tested release-ready version '8.6.9'
- [Built] and tested release-ready version '8.6.9' - dev repo
- [Updated] CHANGELOG
- [Added] the http content response to a job error to aid debugging issues
- [Updated] gems
- [Updated] CHANGELOG
- [new] version created 8.6.10
- [Built] and tested release-ready version '8.6.10'
- [Built] and tested release-ready version '8.6.10' - dev repo
...
- [Fixed] job notification again
- [Fixed] spec to clear cache between requests
- [Ensure] proper nil results for empty environment variables
- [Updated] CHANGELOG
- [Updated] gems
- [new] version created 8.6.11
- [Built] and tested release-ready version '8.6.11'
- [Built] and tested release-ready version '8.6.11' - dev repo
...
- [Updated] CHANGELOG
- [new] version created 8.6.12
- [Built] and tested release-ready version '8.6.12'
- [Built] and tested release-ready version '8.6.12' - dev repo
...
- [Updated] CHANGELOG
- [new] version created 8.6.13
- [Built] and tested release-ready version '8.6.13'
- [Built] and tested release-ready version '8.6.13' - dev repo
...
- [Updated] CHANGELOG
- [new] version created 8.6.14
- [Built] and tested release-ready version '8.6.14'
- [Built] and tested release-ready version '8.6.14' - dev repo
- [Added] new options and date reporting to script
- [Updated] gems
- [Added] cache handling for various
- [Added] bulk lookup of user access controls for a resource type to avoid DB hits
- [Changed] cache handling for protocols
- [Added] security updates
- [Updated] CHANGELOG
- [new] version created 8.6.15
- [Built] and tested release-ready version '8.6.15'
- [Built] and tested release-ready version '8.6.15' - dev repo
...
- [Fixed] cacheing of user access controls to avoid storing an ActiveRecord instance
- [Removed] unnecessary TrackerHandler
- [Added] eager loading of various models to improve performance and reduce database hits
- [Fixed] specs
- [Updated] CHANGELOG
- [new] version created 8.6.16
- [Built] and tested release-ready version '8.6.16'
- [Built] and tested release-ready version '8.6.16' - dev repo
- [Fixed] bad memoization of associated items in app type
- [Updated] CHANGELOG
- [new] version created 8.6.17
- [Built] and tested release-ready version '8.6.17'
- [Built] and tested release-ready version '8.6.17' - dev repo
...
- [Added] "in?" to the simple conditions that can be tested in non-query conditions Added non-query condition elements to specify last as well as first in the traversal of the dot separated list
- [Fixed] an error introduced by list (rather than hash) definitions of save triggers
...
- [Fixed] top level error message handling
...
- [Updated] CHANGELOG
- [Updated] CHANGELOG
- [Added] brakeman ignore item
- [new] version created 8.6.18
- [Built] and tested release-ready version '8.6.18'
- [Built] and tested release-ready version '8.6.18' - dev repo
...
- [Fixed] caching of apps available to users...`
- [Updated] CHANGELOG
- [new] version created 8.6.19
- [Built] and tested release-ready version '8.6.19'
- [Built] and tested release-ready version '8.6.19' - dev repo
- [Updated] CHANGELOG
- [new] version created 8.8.2
- [Built] and tested release-ready version '8.8.2'
- [Built] and tested release-ready version '8.8.2' - dev repo
- [Fixed] CHANGELOG
...
- [Added] estimated record count to redcap project admin details panel
...
- [Added] ability for redcap project associate_master_through_external_identifer to match on external identifiers with integer external ids, by adding an integer redcap_survey_identifier_id field to the dynamic model Added better information around missing fields and mismatched in the redcap project Added the ability to retrieve the latest redcap configuration within the redcap project, so field configurations can be correctly validated Added redcap project run_jobs_as_user and run_jobs_as_app_type options to ensure background jobs run consistently
- [Add] redcap project optionset_master_id_using_association, which adds a master_id to the underlying table and sets it automatically from the external id association - closes #369
...
- [Updated] CHANGELOG
- [Updated] gems
- [Built] and tested release-ready version '8.8.3' - dev repo
...
- [Built] and tested release-ready version '8.8.4' - dev repo
- [Added] RedcapJobUserEmail to setting to be viewed in server info
...
- [Fixed] incorrect error message Added new check to ensure user has access to the associated external id table, if specified
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.8.5' - dev repo
- [Fixed] CHANGELOG
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.8.6' - dev repo
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.8.7' - dev repo
- [Fixed] redcap storage issue with blank survey identifiers
- [Changed] logging to use short backtrace
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.8.8' - dev repo
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.8.9' - dev repo
...
- [Updated] CHANGELOG
- [Changed] brakeman whitelist for new info-pages
- [Built] and tested release-ready version '8.8.10' - dev repo
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.8.11' - dev repo
...
- [Fixed] error setting redcap schema name intermittently Added logging of other potential issues
...
- [Built] and tested release-ready version '8.8.12' - dev repo
- [Updated] schemas for new MSID handling
- [Fixed] symlink to app_reference
- [Fixed] symlinks
- [Pulled] formatting change from upstream
- [Removed] favicon.ico file which is unused
- [Updated] CHANGELOG from upstream
- [Fixed] failing versions list when creating a new dynamic model
- [Updated] gems
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.9.2' - dev repo
- [Updated] CHANGELOG
- [Updated] CHANGELOG
- [Updated] gems to resolve Rails CVEs Updated CHANGELOG
- [Built] and tested release-ready version '8.9.3' - dev repo
...
- [Updated] CHANGELOG
- [Updated] gems
- [Built] and tested release-ready version '8.9.4' - dev repo
...
- [Changed] rake db:structure:* to rails db:schema:*
- [Changed] deprecated ActiveRecord::Base.connection_config
- [Changed] handling of error messages for deprecated `to_h` method
- [Changed] formatting to use `to_fs` rather than deprecated `to_s(format)`
...
- [Updated] brakeman whitelist
- [Fixed] encrypted fields setup in production
- [Fixed] encryption setup in production
- [Fixed] encrypted fields config
- [Fixed] encrypted fields config
- [Added] USEVER variable handling for batch
...
- [Built] and tested release-ready version '9.0.1' - dev repo
- [Fixed] handling of legacy otp for 2FA
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.0.2' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.0.3' - dev repo
...
- [Built] and tested release-ready version '9.0.4' - dev repo
...
- [Updated] gems
- [Fixed] admin forms with dependent fields not setting up on load Fixed admin forms display
- [Fixed] spring stop in parallel test
- [Fixed] error running notify after uploading files Added save_trigger_results to notify
...
- [Added] sample form to external identifiers admin panel Added fields sorter to external identifiers admin panel Added resource name value to external identifiers admin panel
- [Fixed] Zeus Advanced Search protocol not having a sub process query fails with SQL syntax error - fixes #438
- [Updated] CHANGELOG
- [Updated] gems
- [Built] and tested release-ready version '9.0.5' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.0.6' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.0.7' - dev repo
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.0.8' - dev repo
...
- [Updated] CHANGELOG
- [Updated] gems
- [Built] and tested release-ready version '9.1.2' - dev repo
- [Merge] branch 'pr-extend-config-trigger'
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.1.3' - dev repo
- [Added] simplified `with: <String>` option to define item to use in a trigger
- [Fixed] rubocop line length cop for new naming
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.1.4' - dev repo
- [Fixed] CHANGELOG
...
- [Updated] CHANGELOG
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.2.2' - dev repo
- [Fixed] error using embed with simple use of 'embedded_item' or 'dynamic_model__some_recs'
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.2.3' - dev repo
...
- [Updated] CHANGELOG
- [Updated] gems
- [Built] and tested release-ready version '9.2.4' - dev repo
- [Fixed] handling of associate_master_through_external_id when using a field that is not redcap_survey_identifier
- [Added] survey_link, survey_participants and import_records methods to Redcap API
- [Added] first attempt at save trigger for redcap requests
- [Fixed] redcap_request Added spec tests for redcap_request Added documentation for redcap_request
- [Updated] gems
- [Updated] gems
- [Built] and tested release-ready version '9.2.5' - dev repo
...
- [Updated] gems
- [Built] and tested release-ready version '9.2.6' - dev repo
- [Fixed] failure to retrieve production.log due to Pathname
- [Fixed] prepending _comments in extra options
- [Updated] CHANGELOG
- [Updated] gems
- [Built] and tested release-ready version '9.2.7' - dev repo
...
- [Fixed] handling of the dry run and skip failures combination in app type imports - fixes #301 Fixed app type import creating default _app_ user access controls in the matching user's current app. Now switches the app to the new app type on import
...
- [Updated] schema
- [Updated] structrure
- [Built] and tested release-ready version '9.12.1' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.12.2' - dev repo
- [Fixed] db structure using dump of current, which was breaking tests
- [Updated] yarn
- [Updated] gems
- [Updated] bundler gem
- [Updated] brakeman allow list
- [Built] and tested release-ready version '9.12.3' - dev repo
- [Updated] gems
- [Built] and tested release-ready version '9.13.1' - dev repo
- [Updateds] gems
- [Updated] DB structure dump
- [Built] and tested release-ready version '9.14.1' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.15.1' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.16.1' - dev repo
- [Updated] structure
- [Fixed] substitution error when an association returns no results - fixes #526
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.16.2' - dev repo
...
- [Added] documentation for has_not_created_activity
- [Updated] CHANGELOG
- [Updated] gems
- [Built] and tested release-ready version '9.16.3' - dev repo
- [Fixed] regression introduced in #526 - fixes #534
- [Added] return failure value from parallel_specs.sh - resolves #535
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.16.4' - dev repo
- [Fixed] regression in PR #537 when providing additional logging information related to failed calculated conditions
- [Fixed] Activity subprocess for activity logs is not created for as new protocols are added - fixes #543
- [Fixed] Activity subprocess for activity logs is not created as new protocols are added bug - fixes #543
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.16.5' - dev repo
...
- [Updated] CHANGELOG
- [Updated] brakeman allowlist
- [Built] and tested release-ready version '9.16.6' - dev repo
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.16.7' - dev repo
...
- [Fixed] spec tests
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.18.1' - dev repo
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.18.2' - dev repo
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.18.3' - dev repo
- [Updated] CHANGELOG
- [Updated] gems
- [Built] and tested release-ready version '9.18.4' - dev repo
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.19.1' - dev repo
- [Updated] CHANGELOG.md with git commits
- [Built] and tested release-ready version '9.21.1' - dev repo
- [Updated] CHANGELOG
...
- [Fixed] spec
- [Updated] CHANGELOG.md with git commits
- [Built] and tested release-ready version '9.21.2' - dev repo
...
- [Updated] CHANGELOG.md with git commits
- [Built] and tested release-ready version '9.21.3' - dev repo
- [Fixed] incorrect logic showing primary key in report table editing
- [Updated] CHANGELOG.md with git commits
- [Built] and tested release-ready version '9.21.4' - dev repo
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.21.5' - dev repo
...
- [Updated] from stash
- [Added] script to get changelog entries from git and fixed the release script to use it - fixes #641
- [Fixed]  PR details
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.27.0' - dev repo
- [Fixed] Admin users without specific capabilities shouldn't be shown links in app type components sidebar or page - fixes #636 Fixed changes to user or admin not reflected in cached partials
- [Changed] handling of reporting of configuration errors to avoid unnecessary exceptions
- [Changed] enabling of active dynamic definitions to prevent errors from allowing the server to start up
