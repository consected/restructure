...
- [Updated] gems
- [Updated] CHANGELOG
- [Updated] brakeman whitelist for refactored code
- [Revert] use of debug gem
- [Built] and tested release-ready version '8.2.101' - dev repo
...
- [Fixed] view_options.sort_references failing with an exception if a value being sorted is null - fixes #164 Refactored to remove duplicated methods
- [Updated] gems
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.102' - dev repo
- [Updated] CHANGELOG
- [Changed] handling of panel tab caption to ignore blank entries that include carriage returns
- [Fixed] scroll-to-target jumping back up to a link outside the current block
...
- [Updated] CHANGELOG
- [Updated] gems
- [Added] brakeman ignore for conditional calc changes
- [Built] and tested release-ready version '8.2.105' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.106' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.107' - dev repo
- [Updated] CHANGELOG
- [Updated] brakeman whitelist
- [Built] and tested release-ready version '8.2.108' - dev repo
- [Changed] button label
- [Added] CSS for inline buttons
- [Updated] gems and CHANGELOG
- [Built] and tested release-ready version '8.2.109' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.110' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.111' - dev repo
- [Updated] gems
- [Updated] CHANGELOG and bumped version
- [Built] and tested release-ready version '8.2.116' - dev repo
- [Fixed] bug failing to show list
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.117' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.118' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.119' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.120' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.121' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.2.122' - dev repo
...
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.4.7' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.4.8' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.4.9' - dev repo
- [Updated] CHANGELOG and bumped version
- [Built] and tested release-ready version '8.5.2' - dev repo
- [Bring] up to date
- [Viva] only - Bring up to Ruby 3.2.2
...
- [Added] view of reCAPTURE settings to server info
- [Fixed] passing score comparison
- [Updated] CHANGELOG
...
- [Changed] handling of email address lookups from settings to ensure lower case matching is used Added configuration checks for admin and user email addresses set by environment variables
- [Fixed] typo
- [Updated] CHANGELOG
...
- [Add] report handler for sidebar_hash_content_links to ensure these hashed links work correctly
- [Changed] comment in code
- [Updated] CHANGELOG
- [Built] and tested release-ready version '8.6.19' - dev repo
- [Added] null value or disabled checkboxes for report lists
- [Added] null value or disabled checkboxes for report lists
- [Fixed] filestore browser not loading correctly in vertical activity
- [Updated] gems
- [Updated] CHANGELOG
- [Updated] gems
...
- [Added] option to allow empty Unreleased section in relase and build
- [Updated] CHANGELOG
...
- [Changed] cleanup of assets to avoid needing a DB connection
...
- [Updated] schema dump
- [Updated] gems
- [Built] and tested release-ready version '9.13.2' - dev repo
- [Updated] gems and yarn
- [Built] and tested release-ready version '9.13.3' - dev repo
- [Updated] gems and yarn
- [Updated] gems and yarn
- [Built] and tested release-ready version '9.13.4' - dev repo
- [Bumped] version
- [Built] and tested release-ready version '9.14.1' - dev repo
- [Built] and tested release-ready version '9.14.2' - dev repo
...
- [Updated] gems and yarn
- [Built] and tested release-ready version '9.17.1' - dev repo
- [Built] and tested release-ready version '9.20.1' - dev repo
...
- [Updated] CHANGELOG
- [Updated]  brakeman allowlist and commented appropriately
- [Built] and tested release-ready version '9.20.2' - dev repo
...
- [Built] and tested release-ready version '9.20.3' - dev repo
- [Updated] CHANGELOG.md with git commits
- [Built] and tested release-ready version '9.22.1' - dev repo
...
- [Updated] CHANGELOG.md with git commits
- [Updated] gems
- [Built] and tested release-ready version '9.25.2' - dev repo
- [Updated] gems and yarn
- [Built] and tested release-ready version '9.28.1' - dev repo
- [Updated] gems and yarn
- [Built] and tested release-ready version '9.28.2' - dev repo
- [Updated] CHANGELOG
- [Built] and tested release-ready version '9.29.0' - dev repo
