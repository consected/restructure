...
then
  ...
  echo   app-scripts/validate_file_signature.sh /mnt/fphsfs/gid600/app-type-30/containers/207\ --\ e-signature/signed\ document\ by\ phil_ayres\@test.com\ at\ 2019-02-25T14\:09\:53Z.html
else
  if [ -z "$RAILS_ENV" ]
  then
...
$HERE/script/rails runner $HERE/app-scripts/supporting/validate_file_signature.rb
