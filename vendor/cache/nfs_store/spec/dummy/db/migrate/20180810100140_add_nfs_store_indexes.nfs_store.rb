...
class AddNfsStoreIndexes < ActiveRecord::Migration
  def change
    add_index :nfs_store_uploads, [:container_id, :file_hash, :file_name], unique: true, name: 'nfs_store_uploads_unique_file'
    add_index :nfs_store_stored_files, [:container_id, :file_hash, :file_name], unique: true, name: 'nfs_store_stored_files_unique_file'
