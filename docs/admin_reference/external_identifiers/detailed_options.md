# External Identifiers: Detailed Options

All options for an external identifier are placed within the `default:` key.
...
- [_configurations](../general/configurations.md) — runtime settings including `uniqueness_fields`, `can_change_master`, and `foreign_key_through_external_id`
...
- [Record scoping](../general/scoping.md) — which records conditions and substitutions can reach, through the master record
