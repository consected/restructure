...
module StandardAuthentication
  ...
  class_methods do
    ...
    def calculate_strength(password)
      c = password_config
      checker = StrongPassword::StrengthChecker.new(min_word_length: c[:min_word_length], use_dictionary: true, extra_dictionary_words: send(c[:extra_dictionary_words]))
  ...
  def password_expiring_soon?
    set_default_password_expiration
    if password_updated_at < (self.class.expire_password_after - self.class.remind_days_before).days.ago
  ...
  def password_like_email
    if password
      if password && email && password.downcase == email
