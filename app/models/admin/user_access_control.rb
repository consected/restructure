class Admin::UserAccessControl < ActiveRecord::Base
  ...
  def self.resource_names_for resource_type
    if resource_type == :table
      ...
      return ['app_type', 'create_master', 'export_csv', 'export_json', 'view_reports', 'view_external_links', 'edit_report_data', 'create_report_data', 'import_csv', 'print', 'download_files', 'view_files_as_image', 'view_files_as_html', 'send_files_to_trash', 'view_dashboards']
