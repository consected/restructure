...
class Admin::AppConfiguration < Admin::AdminBase
  ...
  def self.configurations
    [
      ...
      'hide navbar search',
      'hide player accuracy', 'hide participant accuracy',
      'hide player tabs', 'hide participant tabs',
      'hide pro info', 'hide secondary info',
      'hide search form advanced', 'hide search form searchable reports',
