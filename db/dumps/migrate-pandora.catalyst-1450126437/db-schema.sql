...
--
-- Name: handle_delete(); Type: FUNCTION; Schema: public; Owner: fphs
--
...
ALTER FUNCTION public.handle_delete() OWNER TO fphs;
...
--
-- Name: tracker_record_delete; Type: TRIGGER; Schema: public; Owner: fphs
--
