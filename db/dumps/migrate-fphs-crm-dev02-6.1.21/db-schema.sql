...
--
-- Name: log_activity_log_survey_assignment_update(); Type: FUNCTION; Schema: ml_app; Owner: -
--

CREATE FUNCTION log_activity_log_survey_assignment_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
              BEGIN
                  INSERT INTO activity_log_survey_assignment_history
                  (
                      master_id,
                      survey_assignment_id,
                      data,
                      select_contact_direction,
                      select_who,
                      contacted_when,
                      select_result,
                      select_next_step,
                      ...
                      created_at,
                      updated_at,
                      activity_log_survey_assignment_id
                      )
                  SELECT
                      NEW.master_id,
                      NEW.survey_assignment_id,
                      NEW.data,
                      NEW.select_contact_direction,
                      NEW.select_who,
                      NEW.contacted_when,
                      NEW.select_result,
                      NEW.select_next_step,
...
--
-- Name: log_survey_assignment_update(); Type: FUNCTION; Schema: ml_app; Owner: -
--

CREATE FUNCTION log_survey_assignment_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
              BEGIN
                  INSERT INTO survey_assignment_history
                  (
                      master_id,
                      survey_id,
                      user_id,
...
--
-- Name: activity_log_survey_assignment_history; Type: TABLE; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE TABLE activity_log_survey_assignment_history (
    id integer NOT NULL,
    master_id integer,
    survey_assignment_id integer,
    data character varying,
    select_contact_direction character varying,
    select_who character varying,
    contacted_when date,
    select_result character varying,
    select_next_step character varying,
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    activity_log_survey_assignment_id integer
);


--
-- Name: activity_log_survey_assignment_history_id_seq; Type: SEQUENCE; Schema: ml_app; Owner: -
--

CREATE SEQUENCE activity_log_survey_assignment_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: activity_log_survey_assignment_history_id_seq; Type: SEQUENCE OWNED BY; Schema: ml_app; Owner: -
--

ALTER SEQUENCE activity_log_survey_assignment_history_id_seq OWNED BY activity_log_survey_assignment_history.id;


--
-- Name: activity_log_survey_assignments; Type: TABLE; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE TABLE activity_log_survey_assignments (
    id integer NOT NULL,
    master_id integer,
    survey_assignment_id integer,
    data character varying,
...
--
-- Name: activity_log_survey_assignments_id_seq; Type: SEQUENCE; Schema: ml_app; Owner: -
--

CREATE SEQUENCE activity_log_survey_assignments_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: activity_log_survey_assignments_id_seq; Type: SEQUENCE OWNED BY; Schema: ml_app; Owner: -
--

ALTER SEQUENCE activity_log_survey_assignments_id_seq OWNED BY activity_log_survey_assignments.id;
...
CREATE TABLE ml_copy (
    ...
    fill_in_addresses character varying(255) DEFAULT NULL::character varying,
    in_survey character varying(255) DEFAULT NULL::character varying,
    verify_survey_participation character varying(255) DEFAULT NULL::character varying,
    verify_player_and_or_match character varying(255) DEFAULT NULL::character varying,
    accuracy character varying(255) DEFAULT NULL::character varying,
    accuracy_score character varying(255) DEFAULT NULL::character varying,
    contactid integer,
    pro_id integer,
    separator_a text,
    ...
    separator_b text,
    pro_first_name character varying(255) DEFAULT NULL::character varying,
    pro_middle_name character varying(255) DEFAULT NULL::character varying,
    pro_last_name character varying(255) DEFAULT NULL::character varying,
    pro_nick_name character varying(255) DEFAULT NULL::character varying,
    birthdate character varying(255) DEFAULT NULL::character varying,
    pro_dob character varying(255) DEFAULT NULL::character varying,
    pro_dod character varying(255) DEFAULT NULL::character varying,
    startyear character varying(255) DEFAULT NULL::character varying,
    pro_start_year character varying(255) DEFAULT NULL::character varying,
    accruedseasons integer,
    pro_end_year character varying(255) DEFAULT NULL::character varying,
    first_contract character varying(255) DEFAULT NULL::character varying,
    second_contract character varying(255) DEFAULT NULL::character varying,
    third_contract character varying(255) DEFAULT NULL::character varying,
    pro_career_info character varying(255) DEFAULT NULL::character varying,
    pro_birthplace character varying(255) DEFAULT NULL::character varying,
    pro_college character varying(255) DEFAULT NULL::character varying,
    email character varying(255) DEFAULT NULL::character varying,
    homecity character varying(255) DEFAULT NULL::character varying,
    homestate character varying(50) DEFAULT NULL::character varying,
    homezipcode character varying(10) DEFAULT NULL::character varying,
    homestreet character varying(255) DEFAULT NULL::character varying,
    homestreet2 character varying(255) DEFAULT NULL::character varying,
    homestreet3 character varying(255) DEFAULT NULL::character varying,
    businesscity character varying(255) DEFAULT NULL::character varying,
    businessstate character varying(50) DEFAULT NULL::character varying,
    businesszipcode character varying(10) DEFAULT NULL::character varying,
    businessstreet character varying(255) DEFAULT NULL::character varying,
    businessstreet2 character varying(255) DEFAULT NULL::character varying,
    businessstreet3 character varying(255) DEFAULT NULL::character varying,
    changed integer,
    changed_column character varying(255) DEFAULT NULL::character varying,
    verified integer,
    notes text,
    email2 character varying(255) DEFAULT NULL::character varying,
    email3 character varying(255) DEFAULT NULL::character varying,
    updatehomestreet character varying(255) DEFAULT NULL::character varying,
    updatehomestreet2 character varying(255) DEFAULT NULL::character varying,
    updatehomecity character varying(255) DEFAULT NULL::character varying,
    updatehomestate character varying(50) DEFAULT NULL::character varying,
    updatehomezipcode character varying(10) DEFAULT NULL::character varying,
    lastmod character varying(255) DEFAULT NULL::character varying,
    sourc character varying(255) DEFAULT NULL::character varying,
    changed_by character varying(255) DEFAULT NULL::character varying,
    msid integer,
    mailing character varying(255) DEFAULT NULL::character varying,
    outreach_vfy character varying(255) DEFAULT NULL::character varying,
    lastupdate text,
    lastupdateby text,
    cprefs character varying(255) DEFAULT NULL::character varying,
    scantronid integer,
    insertauditkey text
);
...
--
-- Name: survey_assignment_history; Type: TABLE; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE TABLE survey_assignment_history (
    id integer NOT NULL,
    master_id integer,
    survey_id bigint,
    user_id integer,
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    survey_assignment_table_id integer
);


--
-- Name: survey_assignment_history_id_seq; Type: SEQUENCE; Schema: ml_app; Owner: -
--

CREATE SEQUENCE survey_assignment_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: survey_assignment_history_id_seq; Type: SEQUENCE OWNED BY; Schema: ml_app; Owner: -
--

ALTER SEQUENCE survey_assignment_history_id_seq OWNED BY survey_assignment_history.id;


--
-- Name: survey_assignments; Type: TABLE; Schema: ml_app; Owner: -; Tablespace: 
--
...
--
-- Name: survey_assignments_id_seq; Type: SEQUENCE; Schema: ml_app; Owner: -
--

CREATE SEQUENCE survey_assignments_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: survey_assignments_id_seq; Type: SEQUENCE OWNED BY; Schema: ml_app; Owner: -
--

ALTER SEQUENCE survey_assignments_id_seq OWNED BY survey_assignments.id;
...
ALTER TABLE ONLY activity_log_survey_assignment_history ALTER COLUMN id SET DEFAULT nextval('activity_log_survey_assignment_history_id_seq'::regclass);
...
ALTER TABLE ONLY activity_log_survey_assignments ALTER COLUMN id SET DEFAULT nextval('activity_log_survey_assignments_id_seq'::regclass);
...
ALTER TABLE ONLY survey_assignment_history ALTER COLUMN id SET DEFAULT nextval('survey_assignment_history_id_seq'::regclass);
...
ALTER TABLE ONLY survey_assignments ALTER COLUMN id SET DEFAULT nextval('survey_assignments_id_seq'::regclass);
...
--
-- Name: activity_log_survey_assignment_history_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -; Tablespace: 
--

ALTER TABLE ONLY activity_log_survey_assignment_history
    ADD CONSTRAINT activity_log_survey_assignment_history_pkey PRIMARY KEY (id);


--
-- Name: activity_log_survey_assignments_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -; Tablespace: 
--

ALTER TABLE ONLY activity_log_survey_assignments
    ADD CONSTRAINT activity_log_survey_assignments_pkey PRIMARY KEY (id);
...
--
-- Name: survey_assignment_history_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -; Tablespace: 
--

ALTER TABLE ONLY survey_assignment_history
    ADD CONSTRAINT survey_assignment_history_pkey PRIMARY KEY (id);


--
-- Name: survey_assignments_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -; Tablespace: 
--

ALTER TABLE ONLY survey_assignments
...
--
-- Name: index_activity_log_survey_assignment_history_on_activity_log_su; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_activity_log_survey_assignment_history_on_activity_log_su ON activity_log_survey_assignment_history USING btree (activity_log_survey_assignment_id);


--
-- Name: index_activity_log_survey_assignment_history_on_master_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_activity_log_survey_assignment_history_on_master_id ON activity_log_survey_assignment_history USING btree (master_id);


--
-- Name: index_activity_log_survey_assignment_history_on_survey_assignme; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_activity_log_survey_assignment_history_on_survey_assignme ON activity_log_survey_assignment_history USING btree (survey_assignment_id);


--
-- Name: index_activity_log_survey_assignment_history_on_user_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_activity_log_survey_assignment_history_on_user_id ON activity_log_survey_assignment_history USING btree (user_id);


--
-- Name: index_activity_log_survey_assignments_on_master_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_activity_log_survey_assignments_on_master_id ON activity_log_survey_assignments USING btree (master_id);


--
-- Name: index_activity_log_survey_assignments_on_survey_assignment_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_activity_log_survey_assignments_on_survey_assignment_id ON activity_log_survey_assignments USING btree (survey_assignment_id);


--
-- Name: index_activity_log_survey_assignments_on_user_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_activity_log_survey_assignments_on_user_id ON activity_log_survey_assignments USING btree (user_id);
...
--
-- Name: index_survey_assignment_history_on_admin_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_survey_assignment_history_on_admin_id ON survey_assignment_history USING btree (admin_id);


--
-- Name: index_survey_assignment_history_on_master_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_survey_assignment_history_on_master_id ON survey_assignment_history USING btree (master_id);


--
-- Name: index_survey_assignment_history_on_survey_assignment_table_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_survey_assignment_history_on_survey_assignment_table_id ON survey_assignment_history USING btree (survey_assignment_table_id);


--
-- Name: index_survey_assignment_history_on_user_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_survey_assignment_history_on_user_id ON survey_assignment_history USING btree (user_id);


--
-- Name: index_survey_assignments_on_admin_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_survey_assignments_on_admin_id ON survey_assignments USING btree (admin_id);


--
-- Name: index_survey_assignments_on_master_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_survey_assignments_on_master_id ON survey_assignments USING btree (master_id);


--
-- Name: index_survey_assignments_on_user_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE INDEX index_survey_assignments_on_user_id ON survey_assignments USING btree (user_id);
...
--
-- Name: activity_log_survey_assignment_history_insert; Type: TRIGGER; Schema: ml_app; Owner: -
--

CREATE TRIGGER activity_log_survey_assignment_history_insert AFTER INSERT ON activity_log_survey_assignments FOR EACH ROW EXECUTE PROCEDURE log_activity_log_survey_assignment_update();


--
-- Name: activity_log_survey_assignment_history_update; Type: TRIGGER; Schema: ml_app; Owner: -
--

CREATE TRIGGER activity_log_survey_assignment_history_update AFTER UPDATE ON activity_log_survey_assignments FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE log_activity_log_survey_assignment_update();
...
--
-- Name: survey_assignment_history_insert; Type: TRIGGER; Schema: ml_app; Owner: -
--

CREATE TRIGGER survey_assignment_history_insert AFTER INSERT ON survey_assignments FOR EACH ROW EXECUTE PROCEDURE log_survey_assignment_update();


--
-- Name: survey_assignment_history_update; Type: TRIGGER; Schema: ml_app; Owner: -
--

CREATE TRIGGER survey_assignment_history_update AFTER UPDATE ON survey_assignments FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE log_survey_assignment_update();
...
--
-- Name: fk_activity_log_survey_assignment_history_activity_log_survey_a; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY activity_log_survey_assignment_history
    ADD CONSTRAINT fk_activity_log_survey_assignment_history_activity_log_survey_a FOREIGN KEY (activity_log_survey_assignment_id) REFERENCES activity_log_survey_assignments(id);


--
-- Name: fk_activity_log_survey_assignment_history_masters; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY activity_log_survey_assignment_history
    ADD CONSTRAINT fk_activity_log_survey_assignment_history_masters FOREIGN KEY (master_id) REFERENCES masters(id);


--
-- Name: fk_activity_log_survey_assignment_history_survey_assignment_id; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY activity_log_survey_assignment_history
    ADD CONSTRAINT fk_activity_log_survey_assignment_history_survey_assignment_id FOREIGN KEY (survey_assignment_id) REFERENCES survey_assignments(id);


--
-- Name: fk_activity_log_survey_assignment_history_users; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY activity_log_survey_assignment_history
    ADD CONSTRAINT fk_activity_log_survey_assignment_history_users FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY activity_log_survey_assignments
    ADD CONSTRAINT fk_rails_78888ed085 FOREIGN KEY (survey_assignment_id) REFERENCES survey_assignments(id);
...
--
-- Name: fk_survey_assignment_history_admins; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY survey_assignment_history
    ADD CONSTRAINT fk_survey_assignment_history_admins FOREIGN KEY (admin_id) REFERENCES admins(id);


--
-- Name: fk_survey_assignment_history_masters; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY survey_assignment_history
    ADD CONSTRAINT fk_survey_assignment_history_masters FOREIGN KEY (master_id) REFERENCES masters(id);


--
-- Name: fk_survey_assignment_history_survey_assignments; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY survey_assignment_history
    ADD CONSTRAINT fk_survey_assignment_history_survey_assignments FOREIGN KEY (survey_assignment_table_id) REFERENCES survey_assignments(id);


--
-- Name: fk_survey_assignment_history_users; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY survey_assignment_history
    ADD CONSTRAINT fk_survey_assignment_history_users FOREIGN KEY (user_id) REFERENCES users(id);
