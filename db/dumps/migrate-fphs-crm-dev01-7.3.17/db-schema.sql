...
--
-- Name: deceased_players_list_2015; Type: TABLE; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE TABLE deceased_players_list_2015 (
    first_name character varying,
    middle_name character varying,
    last_name character varying,
    start_year character varying,
    team_debut character varying,
...
--
-- Name: profootball_master; Type: TABLE; Schema: ml_app; Owner: -; Tablespace: 
--
