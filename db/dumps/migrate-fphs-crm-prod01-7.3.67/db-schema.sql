...
CREATE FUNCTION find_new_local_sleep_records(sel_sub_process_id integer) RETURNS TABLE(master_id integer, sleep_id integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
  RETURN QUERY
...
CREATE VIEW marketo_master_ids AS
 SELECT DISTINCT ON (mi.id) mi.id,
   ...
   FROM (marketo_ids mi
     JOIN player_contacts pc ON ((((pc.data)::text = (mi.email)::text) AND ((pc.rec_type)::text = 'email'::text))));
...
--
-- Name: nfs_store_move_actions; Type: TABLE; Schema: ml_app; Owner: -; Tablespace: 
--

CREATE TABLE nfs_store_move_actions (
    id integer NOT NULL,
    user_groups integer[],
    path character varying,
...
CREATE SEQUENCE nfs_store_move_actions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE nfs_store_move_actions_id_seq OWNED BY nfs_store_move_actions.id;
...
CREATE VIEW q2_rc_links AS
 SELECT rc.id,
    ...
    NULL::integer AS user_id
   FROM (q2.rc_links rc
     JOIN masters ON ((masters.msid = rc.msid)));
...
--
-- Name: sleep_assignment_history; Type: TABLE; Schema: ml_app; Owner: -; Tablespace: 
--
...
--
-- Name: sleep_assignments; Type: TABLE; Schema: ml_app; Owner: -; Tablespace: 
--
...
ALTER TABLE ONLY nfs_store_move_actions ALTER COLUMN id SET DEFAULT nextval('nfs_store_move_actions_id_seq'::regclass);
...
--
-- Name: nfs_store_move_actions_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -; Tablespace: 
--

ALTER TABLE ONLY nfs_store_move_actions
...
--
-- Name: sleep_assignment_history_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -; Tablespace: 
--
...
--
-- Name: sleep_assignments_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -; Tablespace: 
--
...
--
-- Name: index_sleep_assignment_history_on_admin_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--
...
--
-- Name: index_sleep_assignment_history_on_master_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--
...
--
-- Name: index_sleep_assignment_history_on_sleep_assignment_table_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--
...
--
-- Name: index_sleep_assignment_history_on_user_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--
...
--
-- Name: index_sleep_assignments_on_admin_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--
...
--
-- Name: index_sleep_assignments_on_master_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--
...
--
-- Name: index_sleep_assignments_on_user_id; Type: INDEX; Schema: ml_app; Owner: -; Tablespace: 
--
...
ALTER TABLE ONLY nfs_store_move_actions
    ADD CONSTRAINT fk_rails_75138f1972 FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY nfs_store_move_actions
    ADD CONSTRAINT fk_rails_c1ea9a5fd9 FOREIGN KEY (nfs_store_container_id) REFERENCES nfs_store_containers(id);
