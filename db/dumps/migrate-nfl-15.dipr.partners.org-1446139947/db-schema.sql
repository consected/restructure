...
GRANT ALL ON SCHEMA ml_app TO pda11;
...
GRANT SELECT,INSERT,UPDATE ON TABLE dynamic_models TO fphsusr;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE dynamic_models TO fphsadm;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE external_links TO fphsadm;
GRANT SELECT,INSERT,UPDATE ON TABLE external_links TO fphsusr;
...
--
-- Name: player_career_data; Type: ACL; Schema: ml_app; Owner: pda11
--

REVOKE ALL ON TABLE player_career_data FROM PUBLIC;
REVOKE ALL ON TABLE player_career_data FROM pda11;
GRANT ALL ON TABLE player_career_data TO pda11;
GRANT SELECT ON TABLE player_career_data TO fphsusr;
...
--
-- Name: player_severance; Type: ACL; Schema: ml_app; Owner: pda11
--

REVOKE ALL ON TABLE player_severance FROM PUBLIC;
REVOKE ALL ON TABLE player_severance FROM pda11;
GRANT ALL ON TABLE player_severance TO pda11;
GRANT SELECT ON TABLE player_severance TO fphsusr;


--
-- Name: player_transactions; Type: ACL; Schema: ml_app; Owner: pda11
--

REVOKE ALL ON TABLE player_transactions FROM PUBLIC;
REVOKE ALL ON TABLE player_transactions FROM pda11;
GRANT ALL ON TABLE player_transactions TO pda11;
GRANT SELECT ON TABLE player_transactions TO fphsusr;
...
GRANT SELECT,INSERT,UPDATE ON TABLE reports TO fphsusr;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE reports TO fphsadm;
...
GRANT SELECT,INSERT,UPDATE ON TABLE sage_assignments TO fphsusr;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE sage_assignments TO fphsadm;
...
--
-- Name: team_history; Type: ACL; Schema: ml_app; Owner: pda11
--

REVOKE ALL ON TABLE team_history FROM PUBLIC;
REVOKE ALL ON TABLE team_history FROM pda11;
GRANT ALL ON TABLE team_history TO pda11;
GRANT SELECT ON TABLE team_history TO fphsusr;
...
GRANT SELECT,INSERT,UPDATE ON TABLE user_authorizations TO fphsusr;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE user_authorizations TO fphsadm;
