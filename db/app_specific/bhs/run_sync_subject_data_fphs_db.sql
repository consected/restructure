...
\copy (SELECT * FROM player_infos WHERE master_id IN (SELECT master_id FROM temp_bhs_assignments)) TO /tmp/zeus_bhs_player_infos.csv WITH (format csv, header true);
