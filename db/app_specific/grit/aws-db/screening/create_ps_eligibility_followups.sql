...
-- Command line:
-- table_generators/generate.sh dynamic_models_table create grit_ps_eligibility_followups outcome interested_yes_no not_interested_notes consent_to_pass_info_to_msm_yes_no consent_to_pass_info_to_msm_2_yes_no contact_info_notes any_questions_yes_no contact_pi_yes_no additional_questions_yes_no notes
