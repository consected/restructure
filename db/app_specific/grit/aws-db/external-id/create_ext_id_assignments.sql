...
-- table_generators/generate.sh create external_identifiers_table
      ...
      ALTER TABLE ONLY grit_assignment_history
          ADD CONSTRAINT grit_assignment_history_pkey PRIMARY KEY (id);

      ALTER TABLE ONLY grit_assignments
      ...
      ALTER TABLE ONLY grit_assignment_history
          ADD CONSTRAINT fk_grit_assignment_history_users FOREIGN KEY (user_id) REFERENCES users(id);

      ALTER TABLE ONLY grit_assignment_history
          ADD CONSTRAINT fk_grit_assignment_history_admins FOREIGN KEY (admin_id) REFERENCES admins(id);

      ALTER TABLE ONLY grit_assignment_history
          ADD CONSTRAINT fk_grit_assignment_history_masters FOREIGN KEY (master_id) REFERENCES masters(id);

      ALTER TABLE ONLY grit_assignment_history
          ADD CONSTRAINT fk_grit_assignment_history_grit_assignments FOREIGN KEY (grit_assignment_table_id) REFERENCES grit_assignments(id);
