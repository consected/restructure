...
-- table_generators/generate.sh dynamic_models_table create ipa_station_contacts first_name last_name role phone alt_phone email alt_email notes
      ...
      CREATE SEQUENCE ipa_station_contact_history_id_seq
          START WITH 1
          INCREMENT BY 1
          NO MINVALUE
          NO MAXVALUE
      ...
      ALTER SEQUENCE ipa_station_contact_history_id_seq OWNED BY ipa_station_contact_history.id;
      ...
      CREATE SEQUENCE ipa_station_contacts_id_seq
          START WITH 1
          INCREMENT BY 1
          NO MINVALUE
          NO MAXVALUE
      ...
      ALTER SEQUENCE ipa_station_contacts_id_seq OWNED BY ipa_station_contacts.id;

      ALTER TABLE ONLY ipa_station_contacts ALTER COLUMN id SET DEFAULT nextval('ipa_station_contacts_id_seq'::regclass);
      ALTER TABLE ONLY ipa_station_contact_history ALTER COLUMN id SET DEFAULT nextval('ipa_station_contact_history_id_seq'::regclass);
      ...
      CREATE TRIGGER ipa_station_contact_history_insert AFTER INSERT ON ipa_station_contacts FOR EACH ROW EXECUTE PROCEDURE log_ipa_station_contact_update();
      CREATE TRIGGER ipa_station_contact_history_update AFTER UPDATE ON ipa_station_contacts FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE log_ipa_station_contact_update();
      ...
      ALTER TABLE ONLY ipa_station_contact_history
          ADD CONSTRAINT fk_ipa_station_contact_history_ipa_station_contacts FOREIGN KEY (ipa_station_contact_id) REFERENCES ipa_station_contacts(id);
