...
\i db/app_specific/ipa/aws-db/create_activity_log_inex_checklist_table.sql
\i db/app_specific/ipa/aws-db/create_activity_log_ipa_assignment_phone_screens_table.sql
\i db/app_specific/ipa/aws-db/create_activity_log_ipa_assignments.sql
\i db/app_specific/ipa/aws-db/create_activity_log_ipa_protocol_deviations_table.sql
\i db/app_specific/ipa/aws-db/create_activity_log_navigation_table.sql
\i db/app_specific/ipa/aws-db/create_activity_log_post_visit_table.sql
\i db/app_specific/ipa/aws-db/create_adl_screener_data_table.sql
\i db/app_specific/ipa/aws-db/create_emergency_contacts.sql
\i db/app_specific/ipa/aws-db/create_ipa_adl_informant_screener.sql
\i db/app_specific/ipa/aws-db/create_ipa_adverse_events_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_appointment_table.sql
--\i db/app_specific/ipa/aws-db/create_ipa_assignments_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_consent_mailings.sql
\i db/app_specific/ipa/aws-db/create_ipa_hotel_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_inex_checklist_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_init_screening_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_payment_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_protocol_deviations_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_ps_football_experience_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_ps_health_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_ps_informant_details_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_ps_init_screening_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_ps_size_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_ps_mris_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_ps_tmocas_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_screenings_table.sql
\i db/app_specific/ipa/aws-db/create_ipa_sleeps_table.sql
