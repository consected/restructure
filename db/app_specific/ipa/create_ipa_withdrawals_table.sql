...
-- Command line:
-- table_generators/generate.sh dynamic_models_table create ipa_withdrawals select_status select_subject_withdrew_reason select_investigator_terminated lost_to_follow_up_no_yes no_longer_participating_no_yes notes
