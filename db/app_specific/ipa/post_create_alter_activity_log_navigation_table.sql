...
CREATE OR REPLACE FUNCTION log_activity_log_ipa_assignment_navigation_update() RETURNS trigger
    ...
    ALTER TABLE activity_log_ipa_assignment_navigation_history ADD COLUMN select_status varchar;
    ALTER TABLE activity_log_ipa_assignment_navigations ADD COLUMN select_status varchar;
