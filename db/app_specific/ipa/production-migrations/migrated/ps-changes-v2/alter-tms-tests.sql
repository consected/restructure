...
ALTER TABLE ipa_ps_tms_tests
          add column convulsion_or_seizure_details varchar,
          add column epilepsy_details varchar,
          add column fainting_details varchar,
          add column hairstyle_scalp_blank_yes_no_dont_know varchar,
          add column hairstyle_scalp_details varchar
;
