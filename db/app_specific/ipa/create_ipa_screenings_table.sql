      ...
      CREATE TABLE ipa_screening_history (
          ...
          master_id integer,
          screening_date date,
          eligible_for_study_yes_no varchar,
          ...
          lost_to_follow_up_yes_no varchar,
