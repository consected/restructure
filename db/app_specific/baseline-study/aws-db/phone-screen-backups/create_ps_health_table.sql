...
-- table_generators/generate.sh create dynamic_models_table ${target_name_us}_ps_healths false physical_limitations_blank_yes_no physical_limitations_details sit_back_blank_yes_no sit_back_details cycle_blank_yes_no cycle_details chronic_pain_blank_yes_no chronic_pain_details chronic_pain_meds_blank_yes_no_dont_know chronic_pain_meds_details hemophilia_blank_yes_no_dont_know hemophilia_details raynauds_syndrome_blank_yes_no_dont_know raynauds_syndrome_severity_selection raynauds_syndrome_details other_conditions_blank_yes_no_dont_know other_conditions_details hypertension_diagnosis_blank_yes_no_dont_know hypertension_diagnosis_details other_heart_conditions_blank_yes_no_dont_know other_heart_conditions_details memory_problems_blank_yes_no_dont_know memory_problems_details mental_health_conditions_blank_yes_no_dont_know mental_health_conditions_details neurological_problems_blank_yes_no_dont_know neurological_problems_details
      ...
      CREATE TABLE ${target_name_us}_ps_health_history (
          id integer NOT NULL,
          master_id integer,
          ...
          ${target_name_us}_ps_health_id integer
      );

      CREATE SEQUENCE ${target_name_us}_ps_health_history_id_seq
          START WITH 1
          INCREMENT BY 1
          NO MINVALUE
          NO MAXVALUE
      ...
      ALTER SEQUENCE ${target_name_us}_ps_health_history_id_seq OWNED BY ${target_name_us}_ps_health_history.id;

      CREATE TABLE ${target_name_us}_ps_healths (
          id integer NOT NULL,
          master_id integer,
          physical_limitations_blank_yes_no varchar,
          physical_limitations_details varchar,
      ...
      CREATE SEQUENCE ${target_name_us}_ps_healths_id_seq
          START WITH 1
          INCREMENT BY 1
          NO MINVALUE
          NO MAXVALUE
      ...
      ALTER SEQUENCE ${target_name_us}_ps_healths_id_seq OWNED BY ${target_name_us}_ps_healths.id;

      ALTER TABLE ONLY ${target_name_us}_ps_healths ALTER COLUMN id SET DEFAULT nextval('${target_name_us}_ps_healths_id_seq'::regclass);
      ALTER TABLE ONLY ${target_name_us}_ps_health_history ALTER COLUMN id SET DEFAULT nextval('${target_name_us}_ps_health_history_id_seq'::regclass);

      ALTER TABLE ONLY ${target_name_us}_ps_health_history
          ADD CONSTRAINT ${target_name_us}_ps_health_history_pkey PRIMARY KEY (id);

      ALTER TABLE ONLY ${target_name_us}_ps_healths
          ADD CONSTRAINT ${target_name_us}_ps_healths_pkey PRIMARY KEY (id);

      CREATE INDEX index_${target_name_us}_ps_health_history_on_master_id ON ${target_name_us}_ps_health_history USING btree (master_id);


      CREATE INDEX index_${target_name_us}_ps_health_history_on_${target_name_us}_ps_health_id ON ${target_name_us}_ps_health_history USING btree (${target_name_us}_ps_health_id);
      CREATE INDEX index_${target_name_us}_ps_health_history_on_user_id ON ${target_name_us}_ps_health_history USING btree (user_id);

      CREATE INDEX index_${target_name_us}_ps_healths_on_master_id ON ${target_name_us}_ps_healths USING btree (master_id);

      CREATE INDEX index_${target_name_us}_ps_healths_on_user_id ON ${target_name_us}_ps_healths USING btree (user_id);

      CREATE TRIGGER ${target_name_us}_ps_health_history_insert AFTER INSERT ON ${target_name_us}_ps_healths FOR EACH ROW EXECUTE PROCEDURE log_${target_name_us}_ps_health_update();
      CREATE TRIGGER ${target_name_us}_ps_health_history_update AFTER UPDATE ON ${target_name_us}_ps_healths FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE log_${target_name_us}_ps_health_update();
      ...
      ALTER TABLE ONLY ${target_name_us}_ps_health_history
          ADD CONSTRAINT fk_${target_name_us}_ps_health_history_users FOREIGN KEY (user_id) REFERENCES users(id);

      ALTER TABLE ONLY ${target_name_us}_ps_health_history
          ADD CONSTRAINT fk_${target_name_us}_ps_health_history_masters FOREIGN KEY (master_id) REFERENCES masters(id);




      ALTER TABLE ONLY ${target_name_us}_ps_health_history
          ADD CONSTRAINT fk_${target_name_us}_ps_health_history_${target_name_us}_ps_healths FOREIGN KEY (${target_name_us}_ps_health_id) REFERENCES ${target_name_us}_ps_healths(id);
