...
-- Command line:
-- table_generators/generate.sh activity_logs_table create activity_log_ipa_assignment_navigations ipa_assignment event_date select_station arrival_time start_time event_notes completion_time participant_feedback_notes other_navigator_notes add_protocol_deviation_record_no_yes add_adverse_event_record_no_yes select_event_type other_event_type select_status
