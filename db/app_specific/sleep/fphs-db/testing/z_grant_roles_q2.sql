...
GRANT ALL ON ALL TABLES IN SCHEMA q2 TO fphs;
GRANT SELECT,INSERT,UPDATE,DELETE ON ALL TABLES IN SCHEMA q2 TO fphsusr;
GRANT SELECT,INSERT,UPDATE,DELETE ON ALL TABLES IN SCHEMA q2 TO fphsetl;
GRANT SELECT,INSERT,DELETE,TRUNCATE,UPDATE ON ALL TABLES IN SCHEMA q2 TO fphsadm;
...
IF EXISTS (
   ...
   GRANT SELECT,INSERT,UPDATE,DELETE ON ALL TABLES IN SCHEMA q2 TO fphsrailsapp;
   GRANT SELECT,USAGE ON ALL SEQUENCES IN SCHEMA q2 TO fphsrailsapp;
END IF;
