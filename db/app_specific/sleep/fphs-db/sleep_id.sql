...
ALTER TABLE ONLY sleep_assignment_history ADD CONSTRAINT sleep_assignment_history_pkey PRIMARY KEY (id);

ALTER TABLE ONLY sleep_assignments ADD CONSTRAINT sleep_assignments_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY sleep_assignments ADD CONSTRAINT fk_rails_1a7e2b01e0 FOREIGN KEY (user_id) REFERENCES users(id);

ALTER TABLE ONLY sleep_assignments ADD CONSTRAINT fk_rails_1a7e2b01e0admin FOREIGN KEY (admin_id) REFERENCES admins(id);

ALTER TABLE ONLY sleep_assignments ADD CONSTRAINT fk_rails_45205ed085 FOREIGN KEY (master_id) REFERENCES masters(id);


ALTER TABLE ONLY sleep_assignment_history ADD CONSTRAINT fk_sleep_assignment_history_users FOREIGN KEY (user_id) REFERENCES users(id);

ALTER TABLE ONLY sleep_assignment_history ADD CONSTRAINT fk_sleep_assignment_history_admins FOREIGN KEY (admin_id) REFERENCES admins(id);

ALTER TABLE ONLY sleep_assignment_history ADD CONSTRAINT fk_sleep_assignment_history_masters FOREIGN KEY (master_id) REFERENCES masters(id);

ALTER TABLE ONLY sleep_assignment_history ADD CONSTRAINT fk_sleep_assignment_history_sleep_assignments FOREIGN KEY (sleep_assignment_table_id) REFERENCES sleep_assignments(id);
