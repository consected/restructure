...
class UpdateActivityLogIpaAssignmentsQhxk3p < ActiveRecord::Migration[5.2]
  ...
  def change
    ...
    self.prev_fields = %i[ipa_assignment_id select_activity activity_date select_record_from_player_contacts select_direction select_who select_result select_next_step follow_up_when follow_up_time notes select_record_from_addresses]
    # added: []
