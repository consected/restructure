...
class UpdateDataRequestsQfetp9 < ActiveRecord::Migration[5.2]
  ...
  def change
    ...
    self.prev_fields = %i[project_title full_name title institution others_handling_data pm_contact other_pm_contact data_use_agreement_status data_use_agreement_notes terms_of_use_yes_no data_start_date data_end_date other_institution created_by_user_id fphs_analyst_yes_no fphs_server_yes_no fphs_server_tools_notes status off_fphs_server_reason_notes]
