module Seeds
  module ActivityLogPlayerContactPhone
    ...
    def self.create_phone_log_general_selections
      ...
      item_type = "activity_log_player_contact_phone_select_call_direction"
      ...
      item_type = "activity_log_player_contact_phone_select_next_step"
      values = [
      ...
      item_type = "activity_log_player_contact_phone_select_result"
      values = [
      ...
      item_type = "activity_log_player_contact_phone_select_who"
      values = [
    ...
    def self.setup
      ...
      if Rails.env.test? || GeneralSelection.where(item_type: "activity_log_player_contact_phone_select_call_direction").length == 0
