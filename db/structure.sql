...
--
-- Name: log_activity_log_ipa_assignment_e_sign_update(); Type: FUNCTION; Schema: ipa_ops; Owner: -
--

CREATE FUNCTION ipa_ops.log_activity_log_ipa_assignment_e_sign_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
              BEGIN
                  INSERT INTO activity_log_ipa_assignment_e_sign_history
                  (
                      master_id,
                      ipa_assignment_id,
                      e_signed_document,
                      ...
                      e_signed_by,
                      e_signed_code,
                      placeholder_get_started,
                      e_signed_status,
                      placeholder_in_progress,
                      extra_log_type,
                      user_id,
                      created_at,
                      updated_at,
                      activity_log_ipa_assignment_e_sign_id
                      )
                  SELECT
                      NEW.master_id,
                      ...
                      NEW.e_signed_by,
                      NEW.e_signed_code,
                      NEW.placeholder_get_started,
                      NEW.e_signed_status,
                      NEW.placeholder_in_progress,
                      NEW.extra_log_type,
                      NEW.user_id,
                      NEW.created_at,
                      NEW.updated_at,
...
--
-- Name: log_activity_log_ipa_assignment_tms_review_update(); Type: FUNCTION; Schema: ipa_ops; Owner: -
--

CREATE FUNCTION ipa_ops.log_activity_log_ipa_assignment_tms_review_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
              BEGIN
                  INSERT INTO activity_log_ipa_assignment_tms_review_history
                  (
                      master_id,
                      ipa_assignment_id,
                      select_suitable,
                      ...
                      created_at,
                      updated_at,
                      activity_log_ipa_assignment_tms_review_id
                      )
                  SELECT
                      NEW.master_id,
                      NEW.ipa_assignment_id,
...
--
-- Name: log_ipa_file_creator_update(); Type: FUNCTION; Schema: ipa_ops; Owner: -
--

CREATE FUNCTION ipa_ops.log_ipa_file_creator_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
              BEGIN
    ...
    AS $$
              BEGIN
                  ...
                  (
                      ...
                      xray_check,
                      xray_notes,
                      participant_call_yes_no,
                      participant_call_date,
                      participant_call_notes,
                      provider_call_yes_no,
                      provider_call_date,
                      provider_call_notes,
                      reports_sent_yes_no,
                      reports_sent_notes,
                  ...
                  SELECT
                      ...
                      NEW.xray_check,
                      NEW.xray_notes,
                      NEW.participant_call_yes_no,
                      NEW.participant_call_date,
                      NEW.participant_call_notes,
                      NEW.provider_call_yes_no,
                      NEW.provider_call_date,
                      NEW.provider_call_notes,
                      NEW.reports_sent_yes_no,
                      NEW.reports_sent_notes,
                      NEW.report_sent_date,
                      NEW.report_delivery_date,
...
--
-- Name: find_new_remote_persnet_records(); Type: FUNCTION; Schema: ml_app; Owner: -
--

CREATE FUNCTION ml_app.find_new_remote_persnet_records() RETURNS TABLE(master_id integer, persnet_id bigint, container_id integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: log_activity_log_player_info_test_processe_update(); Type: FUNCTION; Schema: ml_app; Owner: -
--

CREATE FUNCTION ml_app.log_activity_log_player_info_test_processe_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
              BEGIN
                  INSERT INTO activity_log_player_info_test_processe_history
                  (
                      master_id,
                      player_info_id,
                      test,
                      ...
                      created_at,
                      updated_at,
                      activity_log_player_info_test_processe_id
                      )
                  SELECT
                      NEW.master_id,
                      NEW.player_info_id,
...
--
-- Name: log_e_signature_update(); Type: FUNCTION; Schema: ml_app; Owner: -
--

CREATE FUNCTION ml_app.log_e_signature_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
              BEGIN
...
--
-- Name: activity_log_ipa_assignment_e_sign_history; Type: TABLE; Schema: ipa_ops; Owner: -
--

CREATE TABLE ipa_ops.activity_log_ipa_assignment_e_sign_history (
    id integer NOT NULL,
    master_id integer,
    ipa_assignment_id integer,
    ...
    placeholder_get_started character varying,
    e_signed_status character varying,
    placeholder_in_progress character varying,
    extra_log_type character varying,
    user_id integer,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    activity_log_ipa_assignment_e_sign_id integer
);


--
-- Name: activity_log_ipa_assignment_e_sign_history_id_seq; Type: SEQUENCE; Schema: ipa_ops; Owner: -
--

CREATE SEQUENCE ipa_ops.activity_log_ipa_assignment_e_sign_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: activity_log_ipa_assignment_e_sign_history_id_seq; Type: SEQUENCE OWNED BY; Schema: ipa_ops; Owner: -
--

ALTER SEQUENCE ipa_ops.activity_log_ipa_assignment_e_sign_history_id_seq OWNED BY ipa_ops.activity_log_ipa_assignment_e_sign_history.id;


--
-- Name: activity_log_ipa_assignment_e_signs; Type: TABLE; Schema: ipa_ops; Owner: -
--

CREATE TABLE ipa_ops.activity_log_ipa_assignment_e_signs (
    id integer NOT NULL,
    master_id integer,
    ipa_assignment_id integer,
    e_signed_document character varying,
...
--
-- Name: activity_log_ipa_assignment_e_signs_id_seq; Type: SEQUENCE; Schema: ipa_ops; Owner: -
--

CREATE SEQUENCE ipa_ops.activity_log_ipa_assignment_e_signs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: activity_log_ipa_assignment_e_signs_id_seq; Type: SEQUENCE OWNED BY; Schema: ipa_ops; Owner: -
--

ALTER SEQUENCE ipa_ops.activity_log_ipa_assignment_e_signs_id_seq OWNED BY ipa_ops.activity_log_ipa_assignment_e_signs.id;
...
--
-- Name: activity_log_ipa_assignment_tms_review_history; Type: TABLE; Schema: ipa_ops; Owner: -
--

CREATE TABLE ipa_ops.activity_log_ipa_assignment_tms_review_history (
    id integer NOT NULL,
    master_id integer,
    ipa_assignment_id integer,
    select_suitable character varying,
    notes character varying,
    extra_log_type character varying,
    user_id integer,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    activity_log_ipa_assignment_tms_review_id integer
);


--
-- Name: activity_log_ipa_assignment_tms_review_history_id_seq; Type: SEQUENCE; Schema: ipa_ops; Owner: -
--

CREATE SEQUENCE ipa_ops.activity_log_ipa_assignment_tms_review_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: activity_log_ipa_assignment_tms_review_history_id_seq; Type: SEQUENCE OWNED BY; Schema: ipa_ops; Owner: -
--

ALTER SEQUENCE ipa_ops.activity_log_ipa_assignment_tms_review_history_id_seq OWNED BY ipa_ops.activity_log_ipa_assignment_tms_review_history.id;


--
-- Name: activity_log_ipa_assignment_tms_reviews; Type: TABLE; Schema: ipa_ops; Owner: -
--

CREATE TABLE ipa_ops.activity_log_ipa_assignment_tms_reviews (
    id integer NOT NULL,
    master_id integer,
    ipa_assignment_id integer,
    select_suitable character varying,
...
--
-- Name: activity_log_ipa_assignment_tms_reviews_id_seq; Type: SEQUENCE; Schema: ipa_ops; Owner: -
--

CREATE SEQUENCE ipa_ops.activity_log_ipa_assignment_tms_reviews_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: activity_log_ipa_assignment_tms_reviews_id_seq; Type: SEQUENCE OWNED BY; Schema: ipa_ops; Owner: -
--

ALTER SEQUENCE ipa_ops.activity_log_ipa_assignment_tms_reviews_id_seq OWNED BY ipa_ops.activity_log_ipa_assignment_tms_reviews.id;
...
--
-- Name: ipa_file_creator_history; Type: TABLE; Schema: ipa_ops; Owner: -
--

CREATE TABLE ipa_ops.ipa_file_creator_history (
    id integer NOT NULL,
    first_name character varying,
    last_name character varying,
    email character varying,
    staff_id_no character varying,
...
--
-- Name: ipa_file_creator_history_id_seq; Type: SEQUENCE; Schema: ipa_ops; Owner: -
--

CREATE SEQUENCE ipa_ops.ipa_file_creator_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ipa_file_creator_history_id_seq; Type: SEQUENCE OWNED BY; Schema: ipa_ops; Owner: -
--

ALTER SEQUENCE ipa_ops.ipa_file_creator_history_id_seq OWNED BY ipa_ops.ipa_file_creator_history.id;


--
-- Name: ipa_file_creators; Type: TABLE; Schema: ipa_ops; Owner: -
--

CREATE TABLE ipa_ops.ipa_file_creators (
    id integer NOT NULL,
    first_name character varying,
    last_name character varying,
    email character varying,
...
--
-- Name: ipa_file_creators_id_seq; Type: SEQUENCE; Schema: ipa_ops; Owner: -
--

CREATE SEQUENCE ipa_ops.ipa_file_creators_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ipa_file_creators_id_seq; Type: SEQUENCE OWNED BY; Schema: ipa_ops; Owner: -
--

ALTER SEQUENCE ipa_ops.ipa_file_creators_id_seq OWNED BY ipa_ops.ipa_file_creators.id;
...
CREATE TABLE ipa_ops.ipa_four_wk_followup_history (
    ...
    reports_sent_yes_no character varying,
    reports_sent_notes character varying,
...
CREATE TABLE ipa_ops.ipa_mednav_followup_history (
    ...
    xray_check boolean,
    xray_notes character varying,
    participant_call_yes_no character varying,
    participant_call_date date,
    participant_call_notes character varying,
    provider_call_yes_no character varying,
    provider_call_date date,
    provider_call_notes character varying,
    reports_sent_yes_no character varying,
    reports_sent_notes character varying,
    report_sent_date date,
    report_delivery_date date,
...
CREATE TABLE ipa_ops.ipa_two_wk_followup_history (
    ...
    master_id integer,
    call_date date,
    call_completed_yes_no character varying,
    call_completed_notes character varying,
...
--
-- Name: activity_log_player_info_test_processe_history; Type: TABLE; Schema: ml_app; Owner: -
--

CREATE TABLE ml_app.activity_log_player_info_test_processe_history (
    id integer NOT NULL,
    master_id integer,
    player_info_id integer,
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    activity_log_player_info_test_processe_id integer
);


--
-- Name: activity_log_player_info_test_processe_history_id_seq; Type: SEQUENCE; Schema: ml_app; Owner: -
--

CREATE SEQUENCE ml_app.activity_log_player_info_test_processe_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: activity_log_player_info_test_processe_history_id_seq; Type: SEQUENCE OWNED BY; Schema: ml_app; Owner: -
--

ALTER SEQUENCE ml_app.activity_log_player_info_test_processe_history_id_seq OWNED BY ml_app.activity_log_player_info_test_processe_history.id;


--
-- Name: activity_log_player_info_test_processes; Type: TABLE; Schema: ml_app; Owner: -
--

CREATE TABLE ml_app.activity_log_player_info_test_processes (
    id integer NOT NULL,
    master_id integer,
    player_info_id integer,
    test character varying,
...
--
-- Name: activity_log_player_info_test_processes_id_seq; Type: SEQUENCE; Schema: ml_app; Owner: -
--

CREATE SEQUENCE ml_app.activity_log_player_info_test_processes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: activity_log_player_info_test_processes_id_seq; Type: SEQUENCE OWNED BY; Schema: ml_app; Owner: -
--

ALTER SEQUENCE ml_app.activity_log_player_info_test_processes_id_seq OWNED BY ml_app.activity_log_player_info_test_processes.id;
...
--
-- Name: e_signature_history; Type: TABLE; Schema: ml_app; Owner: -
--

CREATE TABLE ml_app.e_signature_history (
    id integer NOT NULL,
    master_id integer,
    e_signed_document character varying,
    e_signed_how character varying,
    e_signed_at timestamp without time zone,
    e_signed_by character varying,
    e_signed_code character varying,
    user_id integer,
    created_at timestamp without time zone NOT NULL,
...
--
-- Name: e_signature_history_id_seq; Type: SEQUENCE; Schema: ml_app; Owner: -
--

CREATE SEQUENCE ml_app.e_signature_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: e_signature_history_id_seq; Type: SEQUENCE OWNED BY; Schema: ml_app; Owner: -
--

ALTER SEQUENCE ml_app.e_signature_history_id_seq OWNED BY ml_app.e_signature_history.id;


--
-- Name: e_signatures; Type: TABLE; Schema: ml_app; Owner: -
--

CREATE TABLE ml_app.e_signatures (
    id integer NOT NULL,
    master_id integer,
    e_signed_document character varying,
    e_signed_how character varying,
...
--
-- Name: e_signatures_id_seq; Type: SEQUENCE; Schema: ml_app; Owner: -
--

CREATE SEQUENCE ml_app.e_signatures_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: e_signatures_id_seq; Type: SEQUENCE OWNED BY; Schema: ml_app; Owner: -
--

ALTER SEQUENCE ml_app.e_signatures_id_seq OWNED BY ml_app.e_signatures.id;
...
ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_e_sign_history ALTER COLUMN id SET DEFAULT nextval('ipa_ops.activity_log_ipa_assignment_e_sign_history_id_seq'::regclass);
...
ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_e_signs ALTER COLUMN id SET DEFAULT nextval('ipa_ops.activity_log_ipa_assignment_e_signs_id_seq'::regclass);
...
ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_tms_review_history ALTER COLUMN id SET DEFAULT nextval('ipa_ops.activity_log_ipa_assignment_tms_review_history_id_seq'::regclass);
...
ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_tms_reviews ALTER COLUMN id SET DEFAULT nextval('ipa_ops.activity_log_ipa_assignment_tms_reviews_id_seq'::regclass);
...
ALTER TABLE ONLY ipa_ops.ipa_file_creator_history ALTER COLUMN id SET DEFAULT nextval('ipa_ops.ipa_file_creator_history_id_seq'::regclass);
...
ALTER TABLE ONLY ipa_ops.ipa_file_creators ALTER COLUMN id SET DEFAULT nextval('ipa_ops.ipa_file_creators_id_seq'::regclass);
...
ALTER TABLE ONLY ml_app.activity_log_player_info_test_processe_history ALTER COLUMN id SET DEFAULT nextval('ml_app.activity_log_player_info_test_processe_history_id_seq'::regclass);
...
ALTER TABLE ONLY ml_app.activity_log_player_info_test_processes ALTER COLUMN id SET DEFAULT nextval('ml_app.activity_log_player_info_test_processes_id_seq'::regclass);
...
ALTER TABLE ONLY ml_app.e_signature_history ALTER COLUMN id SET DEFAULT nextval('ml_app.e_signature_history_id_seq'::regclass);
...
ALTER TABLE ONLY ml_app.e_signatures ALTER COLUMN id SET DEFAULT nextval('ml_app.e_signatures_id_seq'::regclass);
...
--
-- Name: activity_log_ipa_assignment_e_sign_history_pkey; Type: CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_e_sign_history
    ADD CONSTRAINT activity_log_ipa_assignment_e_sign_history_pkey PRIMARY KEY (id);


--
-- Name: activity_log_ipa_assignment_e_signs_pkey; Type: CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_e_signs
    ADD CONSTRAINT activity_log_ipa_assignment_e_signs_pkey PRIMARY KEY (id);
...
--
-- Name: activity_log_ipa_assignment_tms_review_history_pkey; Type: CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_tms_review_history
    ADD CONSTRAINT activity_log_ipa_assignment_tms_review_history_pkey PRIMARY KEY (id);


--
-- Name: activity_log_ipa_assignment_tms_reviews_pkey; Type: CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_tms_reviews
    ADD CONSTRAINT activity_log_ipa_assignment_tms_reviews_pkey PRIMARY KEY (id);
...
--
-- Name: ipa_file_creator_history_pkey; Type: CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.ipa_file_creator_history
    ADD CONSTRAINT ipa_file_creator_history_pkey PRIMARY KEY (id);


--
-- Name: ipa_file_creators_pkey; Type: CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.ipa_file_creators
...
--
-- Name: activity_log_player_info_test_processe_history_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.activity_log_player_info_test_processe_history
    ADD CONSTRAINT activity_log_player_info_test_processe_history_pkey PRIMARY KEY (id);


--
-- Name: activity_log_player_info_test_processes_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.activity_log_player_info_test_processes
    ADD CONSTRAINT activity_log_player_info_test_processes_pkey PRIMARY KEY (id);
...
--
-- Name: e_signature_history_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.e_signature_history
    ADD CONSTRAINT e_signature_history_pkey PRIMARY KEY (id);


--
-- Name: e_signatures_pkey; Type: CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.e_signatures
...
--
-- Name: index_activity_log_ipa_assignment_e_signs_on_ipa_assignment_e_s; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_activity_log_ipa_assignment_e_signs_on_ipa_assignment_e_s ON ipa_ops.activity_log_ipa_assignment_e_signs USING btree (ipa_assignment_id);


--
-- Name: index_activity_log_ipa_assignment_e_signs_on_master_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_activity_log_ipa_assignment_e_signs_on_master_id ON ipa_ops.activity_log_ipa_assignment_e_signs USING btree (master_id);


--
-- Name: index_activity_log_ipa_assignment_e_signs_on_user_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_activity_log_ipa_assignment_e_signs_on_user_id ON ipa_ops.activity_log_ipa_assignment_e_signs USING btree (user_id);
...
--
-- Name: index_activity_log_ipa_assignment_tms_reviews_on_ipa_assignment; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_activity_log_ipa_assignment_tms_reviews_on_ipa_assignment ON ipa_ops.activity_log_ipa_assignment_tms_reviews USING btree (ipa_assignment_id);


--
-- Name: index_activity_log_ipa_assignment_tms_reviews_on_master_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_activity_log_ipa_assignment_tms_reviews_on_master_id ON ipa_ops.activity_log_ipa_assignment_tms_reviews USING btree (master_id);


--
-- Name: index_activity_log_ipa_assignment_tms_reviews_on_user_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_activity_log_ipa_assignment_tms_reviews_on_user_id ON ipa_ops.activity_log_ipa_assignment_tms_reviews USING btree (user_id);
...
--
-- Name: index_al_ipa_assignment_e_sign_history_on_activity_log_ipa_assi; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_al_ipa_assignment_e_sign_history_on_activity_log_ipa_assi ON ipa_ops.activity_log_ipa_assignment_e_sign_history USING btree (activity_log_ipa_assignment_e_sign_id);


--
-- Name: index_al_ipa_assignment_e_sign_history_on_ipa_assignment_e_sign; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_al_ipa_assignment_e_sign_history_on_ipa_assignment_e_sign ON ipa_ops.activity_log_ipa_assignment_e_sign_history USING btree (ipa_assignment_id);


--
-- Name: index_al_ipa_assignment_e_sign_history_on_master_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_al_ipa_assignment_e_sign_history_on_master_id ON ipa_ops.activity_log_ipa_assignment_e_sign_history USING btree (master_id);


--
-- Name: index_al_ipa_assignment_e_sign_history_on_user_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_al_ipa_assignment_e_sign_history_on_user_id ON ipa_ops.activity_log_ipa_assignment_e_sign_history USING btree (user_id);
...
--
-- Name: index_al_ipa_assignment_tms_review_history_on_activity_log_ipa_; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_al_ipa_assignment_tms_review_history_on_activity_log_ipa_ ON ipa_ops.activity_log_ipa_assignment_tms_review_history USING btree (activity_log_ipa_assignment_tms_review_id);


--
-- Name: index_al_ipa_assignment_tms_review_history_on_ipa_assignment_tm; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_al_ipa_assignment_tms_review_history_on_ipa_assignment_tm ON ipa_ops.activity_log_ipa_assignment_tms_review_history USING btree (ipa_assignment_id);


--
-- Name: index_al_ipa_assignment_tms_review_history_on_master_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_al_ipa_assignment_tms_review_history_on_master_id ON ipa_ops.activity_log_ipa_assignment_tms_review_history USING btree (master_id);


--
-- Name: index_al_ipa_assignment_tms_review_history_on_user_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_al_ipa_assignment_tms_review_history_on_user_id ON ipa_ops.activity_log_ipa_assignment_tms_review_history USING btree (user_id);
...
--
-- Name: index_ipa_file_creator_history_on_ipa_file_creator_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_ipa_file_creator_history_on_ipa_file_creator_id ON ipa_ops.ipa_file_creator_history USING btree (ipa_file_creator_id);


--
-- Name: index_ipa_file_creator_history_on_user_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_ipa_file_creator_history_on_user_id ON ipa_ops.ipa_file_creator_history USING btree (user_id);


--
-- Name: index_ipa_file_creators_on_user_id; Type: INDEX; Schema: ipa_ops; Owner: -
--

CREATE INDEX index_ipa_file_creators_on_user_id ON ipa_ops.ipa_file_creators USING btree (user_id);
...
--
-- Name: index_activity_log_player_info_test_processes_on_master_id; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_activity_log_player_info_test_processes_on_master_id ON ml_app.activity_log_player_info_test_processes USING btree (master_id);


--
-- Name: index_activity_log_player_info_test_processes_on_player_info_te; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_activity_log_player_info_test_processes_on_player_info_te ON ml_app.activity_log_player_info_test_processes USING btree (player_info_id);


--
-- Name: index_activity_log_player_info_test_processes_on_user_id; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_activity_log_player_info_test_processes_on_user_id ON ml_app.activity_log_player_info_test_processes USING btree (user_id);
...
--
-- Name: index_al_player_info_test_processe_history_on_activity_log_play; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_al_player_info_test_processe_history_on_activity_log_play ON ml_app.activity_log_player_info_test_processe_history USING btree (activity_log_player_info_test_processe_id);


--
-- Name: index_al_player_info_test_processe_history_on_master_id; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_al_player_info_test_processe_history_on_master_id ON ml_app.activity_log_player_info_test_processe_history USING btree (master_id);


--
-- Name: index_al_player_info_test_processe_history_on_player_info_test_; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_al_player_info_test_processe_history_on_player_info_test_ ON ml_app.activity_log_player_info_test_processe_history USING btree (player_info_id);


--
-- Name: index_al_player_info_test_processe_history_on_user_id; Type: INDEX; Schema: ml_app; Owner: -
--
...
--
-- Name: index_e_signature_history_on_e_signature_id; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_e_signature_history_on_e_signature_id ON ml_app.e_signature_history USING btree (e_signature_id);


--
-- Name: index_e_signature_history_on_master_id; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_e_signature_history_on_master_id ON ml_app.e_signature_history USING btree (master_id);


--
-- Name: index_e_signature_history_on_user_id; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_e_signature_history_on_user_id ON ml_app.e_signature_history USING btree (user_id);


--
-- Name: index_e_signatures_on_master_id; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_e_signatures_on_master_id ON ml_app.e_signatures USING btree (master_id);


--
-- Name: index_e_signatures_on_user_id; Type: INDEX; Schema: ml_app; Owner: -
--

CREATE INDEX index_e_signatures_on_user_id ON ml_app.e_signatures USING btree (user_id);
...
--
-- Name: activity_log_ipa_assignment_e_sign_history_insert; Type: TRIGGER; Schema: ipa_ops; Owner: -
--

CREATE TRIGGER activity_log_ipa_assignment_e_sign_history_insert AFTER INSERT ON ipa_ops.activity_log_ipa_assignment_e_signs FOR EACH ROW EXECUTE PROCEDURE ipa_ops.log_activity_log_ipa_assignment_e_sign_update();


--
-- Name: activity_log_ipa_assignment_e_sign_history_update; Type: TRIGGER; Schema: ipa_ops; Owner: -
--

CREATE TRIGGER activity_log_ipa_assignment_e_sign_history_update AFTER UPDATE ON ipa_ops.activity_log_ipa_assignment_e_signs FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE ipa_ops.log_activity_log_ipa_assignment_e_sign_update();
...
--
-- Name: activity_log_ipa_assignment_tms_review_history_insert; Type: TRIGGER; Schema: ipa_ops; Owner: -
--

CREATE TRIGGER activity_log_ipa_assignment_tms_review_history_insert AFTER INSERT ON ipa_ops.activity_log_ipa_assignment_tms_reviews FOR EACH ROW EXECUTE PROCEDURE ipa_ops.log_activity_log_ipa_assignment_tms_review_update();


--
-- Name: activity_log_ipa_assignment_tms_review_history_update; Type: TRIGGER; Schema: ipa_ops; Owner: -
--

CREATE TRIGGER activity_log_ipa_assignment_tms_review_history_update AFTER UPDATE ON ipa_ops.activity_log_ipa_assignment_tms_reviews FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE ipa_ops.log_activity_log_ipa_assignment_tms_review_update();
...
--
-- Name: ipa_file_creator_history_insert; Type: TRIGGER; Schema: ipa_ops; Owner: -
--

CREATE TRIGGER ipa_file_creator_history_insert AFTER INSERT ON ipa_ops.ipa_file_creators FOR EACH ROW EXECUTE PROCEDURE ipa_ops.log_ipa_file_creator_update();


--
-- Name: ipa_file_creator_history_update; Type: TRIGGER; Schema: ipa_ops; Owner: -
--

CREATE TRIGGER ipa_file_creator_history_update AFTER UPDATE ON ipa_ops.ipa_file_creators FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE ipa_ops.log_ipa_file_creator_update();
...
--
-- Name: activity_log_player_info_test_processe_history_insert; Type: TRIGGER; Schema: ml_app; Owner: -
--

CREATE TRIGGER activity_log_player_info_test_processe_history_insert AFTER INSERT ON ml_app.activity_log_player_info_test_processes FOR EACH ROW EXECUTE PROCEDURE ml_app.log_activity_log_player_info_test_processe_update();


--
-- Name: activity_log_player_info_test_processe_history_update; Type: TRIGGER; Schema: ml_app; Owner: -
--

CREATE TRIGGER activity_log_player_info_test_processe_history_update AFTER UPDATE ON ml_app.activity_log_player_info_test_processes FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE ml_app.log_activity_log_player_info_test_processe_update();
...
--
-- Name: e_signature_history_insert; Type: TRIGGER; Schema: ml_app; Owner: -
--

CREATE TRIGGER e_signature_history_insert AFTER INSERT ON ml_app.e_signatures FOR EACH ROW EXECUTE PROCEDURE ml_app.log_e_signature_update();


--
-- Name: e_signature_history_update; Type: TRIGGER; Schema: ml_app; Owner: -
--

CREATE TRIGGER e_signature_history_update AFTER UPDATE ON ml_app.e_signatures FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE ml_app.log_e_signature_update();
...
--
-- Name: fk_activity_log_ipa_assignment_e_sign_history_activity_log_ipa_; Type: FK CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_e_sign_history
    ADD CONSTRAINT fk_activity_log_ipa_assignment_e_sign_history_activity_log_ipa_ FOREIGN KEY (activity_log_ipa_assignment_e_sign_id) REFERENCES ipa_ops.activity_log_ipa_assignment_e_signs(id);


--
-- Name: fk_activity_log_ipa_assignment_e_sign_history_ipa_assignment_e_; Type: FK CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_e_sign_history
    ADD CONSTRAINT fk_activity_log_ipa_assignment_e_sign_history_ipa_assignment_e_ FOREIGN KEY (ipa_assignment_id) REFERENCES ipa_ops.ipa_assignments(id);


--
-- Name: fk_activity_log_ipa_assignment_e_sign_history_masters; Type: FK CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_e_sign_history
    ADD CONSTRAINT fk_activity_log_ipa_assignment_e_sign_history_masters FOREIGN KEY (master_id) REFERENCES ml_app.masters(id);


--
-- Name: fk_activity_log_ipa_assignment_e_sign_history_users; Type: FK CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_e_sign_history
    ADD CONSTRAINT fk_activity_log_ipa_assignment_e_sign_history_users FOREIGN KEY (user_id) REFERENCES ml_app.users(id);
...
--
-- Name: fk_activity_log_ipa_assignment_tms_review_history_activity_log_; Type: FK CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_tms_review_history
    ADD CONSTRAINT fk_activity_log_ipa_assignment_tms_review_history_activity_log_ FOREIGN KEY (activity_log_ipa_assignment_tms_review_id) REFERENCES ipa_ops.activity_log_ipa_assignment_tms_reviews(id);


--
-- Name: fk_activity_log_ipa_assignment_tms_review_history_ipa_assignmen; Type: FK CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_tms_review_history
    ADD CONSTRAINT fk_activity_log_ipa_assignment_tms_review_history_ipa_assignmen FOREIGN KEY (ipa_assignment_id) REFERENCES ipa_ops.ipa_assignments(id);


--
-- Name: fk_activity_log_ipa_assignment_tms_review_history_masters; Type: FK CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_tms_review_history
    ADD CONSTRAINT fk_activity_log_ipa_assignment_tms_review_history_masters FOREIGN KEY (master_id) REFERENCES ml_app.masters(id);


--
-- Name: fk_activity_log_ipa_assignment_tms_review_history_users; Type: FK CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.activity_log_ipa_assignment_tms_review_history
    ADD CONSTRAINT fk_activity_log_ipa_assignment_tms_review_history_users FOREIGN KEY (user_id) REFERENCES ml_app.users(id);
...
--
-- Name: fk_ipa_file_creator_history_ipa_file_creators; Type: FK CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.ipa_file_creator_history
    ADD CONSTRAINT fk_ipa_file_creator_history_ipa_file_creators FOREIGN KEY (ipa_file_creator_id) REFERENCES ipa_ops.ipa_file_creators(id);


--
-- Name: fk_ipa_file_creator_history_users; Type: FK CONSTRAINT; Schema: ipa_ops; Owner: -
--

ALTER TABLE ONLY ipa_ops.ipa_file_creator_history
    ADD CONSTRAINT fk_ipa_file_creator_history_users FOREIGN KEY (user_id) REFERENCES ml_app.users(id);
...
--
-- Name: fk_activity_log_player_info_test_processe_history_activity_log_; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.activity_log_player_info_test_processe_history
    ADD CONSTRAINT fk_activity_log_player_info_test_processe_history_activity_log_ FOREIGN KEY (activity_log_player_info_test_processe_id) REFERENCES ml_app.activity_log_player_info_test_processes(id);


--
-- Name: fk_activity_log_player_info_test_processe_history_masters; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.activity_log_player_info_test_processe_history
    ADD CONSTRAINT fk_activity_log_player_info_test_processe_history_masters FOREIGN KEY (master_id) REFERENCES ml_app.masters(id);


--
-- Name: fk_activity_log_player_info_test_processe_history_player_info_t; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.activity_log_player_info_test_processe_history
    ADD CONSTRAINT fk_activity_log_player_info_test_processe_history_player_info_t FOREIGN KEY (player_info_id) REFERENCES ml_app.player_infos(id);


--
-- Name: fk_activity_log_player_info_test_processe_history_users; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.activity_log_player_info_test_processe_history
    ADD CONSTRAINT fk_activity_log_player_info_test_processe_history_users FOREIGN KEY (user_id) REFERENCES ml_app.users(id);
...
--
-- Name: fk_e_signature_history_e_signatures; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.e_signature_history
    ADD CONSTRAINT fk_e_signature_history_e_signatures FOREIGN KEY (e_signature_id) REFERENCES ml_app.e_signatures(id);


--
-- Name: fk_e_signature_history_masters; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.e_signature_history
    ADD CONSTRAINT fk_e_signature_history_masters FOREIGN KEY (master_id) REFERENCES ml_app.masters(id);


--
-- Name: fk_e_signature_history_users; Type: FK CONSTRAINT; Schema: ml_app; Owner: -
--

ALTER TABLE ONLY ml_app.e_signature_history
    ADD CONSTRAINT fk_e_signature_history_users FOREIGN KEY (user_id) REFERENCES ml_app.users(id);
