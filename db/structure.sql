...
BEGIN
  INSERT INTO data_variable_package_history (
    ...
    name, package_type, storage_type, db_or_fs, schema_or_path, table_or_file, is_static, sourced_from_packages, n_for_timepoints, description, disabled,
    user_id,
    created_at,
    updated_at,
  ...
  SELECT
    ...
    NEW.name, NEW.package_type, NEW.storage_type, NEW.db_or_fs, NEW.schema_or_path, NEW.table_or_file, NEW.is_static, NEW.sourced_from_packages, NEW.n_for_timepoints, NEW.description, NEW.disabled,
    NEW.user_id,
    NEW.created_at,
    NEW.updated_at,
    NEW.id;
...
--
-- Name: data_variable_package_history_pkey; Type: CONSTRAINT; Schema: ref_data; Owner: -
--
...
--
-- Name: data_variable_package_var_history_pkey; Type: CONSTRAINT; Schema: ref_data; Owner: -
--
...
--
-- Name: data_variable_package_vars_pkey; Type: CONSTRAINT; Schema: ref_data; Owner: -
--
...
--
-- Name: data_variable_packages_pkey; Type: CONSTRAINT; Schema: ref_data; Owner: -
--
...
CREATE TRIGGER grit_assignment_history_insert AFTER INSERT ON ml_app.grit_assignments FOR EACH ROW EXECUTE PROCEDURE grit.log_grit_assignment_update();
...
CREATE TRIGGER grit_assignment_history_update AFTER UPDATE ON ml_app.grit_assignments FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE grit.log_grit_assignment_update();
...
--
-- Name: log_data_variable_package_history_insert; Type: TRIGGER; Schema: ref_data; Owner: -
--

CREATE TRIGGER log_data_variable_package_history_insert AFTER INSERT ON ref_data.data_variable_packages FOR EACH ROW EXECUTE PROCEDURE ref_data.log_data_variable_packages_update();


--
-- Name: log_data_variable_package_history_update; Type: TRIGGER; Schema: ref_data; Owner: -
--

CREATE TRIGGER log_data_variable_package_history_update AFTER UPDATE ON ref_data.data_variable_packages FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE ref_data.log_data_variable_packages_update();


--
-- Name: log_data_variable_package_var_history_insert; Type: TRIGGER; Schema: ref_data; Owner: -
--

CREATE TRIGGER log_data_variable_package_var_history_insert AFTER INSERT ON ref_data.data_variable_package_vars FOR EACH ROW EXECUTE PROCEDURE ref_data.log_data_variable_package_vars_update();


--
-- Name: log_data_variable_package_var_history_update; Type: TRIGGER; Schema: ref_data; Owner: -
--

CREATE TRIGGER log_data_variable_package_var_history_update AFTER UPDATE ON ref_data.data_variable_package_vars FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE PROCEDURE ref_data.log_data_variable_package_vars_update();
...
--
-- Name: fk_rails_3935f6da80; Type: FK CONSTRAINT; Schema: ref_data; Owner: -
--
...
--
-- Name: fk_rails_45489901da; Type: FK CONSTRAINT; Schema: ref_data; Owner: -
--
...
--
-- Name: fk_rails_a89c82cd43; Type: FK CONSTRAINT; Schema: ref_data; Owner: -
--
