class AddOptionsToExternalIdentifiers < ActiveRecord::Migration[5.2]
  def change
    add_column :external_identifiers, :options, :string

    execute <<~END_SQL

      ALTER TABLE external_identifier_history ADD COLUMN options varchar;
