...
class AddTitleToDatadicVariables < ActiveRecord::Migration[5.2]
  include ActiveRecord::Migration::SqlHelpers
  def change
    add_column 'ref_data.datadic_variables', :title, :string
    add_column 'ref_data.datadic_variable_history', :title, :string
