class AddHistoryToNfsStoreStoredFiles < ActiveRecord::Migration
  def change
...
DROP TABLE if exists nfs_store_stored_file_history CASCADE;
DROP FUNCTION if exists log_nfs_store_stored_file_update() CASCADE;
