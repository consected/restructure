...
IF EXISTS (
   ...
   GRANT USAGE ON SCHEMA ml_app TO fphsrailsapp1;
   GRANT SELECT,INSERT,UPDATE,DELETE ON ALL TABLES IN SCHEMA ml_app TO fphsrailsapp1;
   GRANT SELECT,USAGE ON ALL SEQUENCES IN SCHEMA ml_app TO fphsrailsapp1;
END IF;
