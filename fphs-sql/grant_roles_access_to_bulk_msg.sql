...
IF EXISTS (
   ...
   GRANT USAGE ON SCHEMA bulk_msg TO fphsrailsapp1;
   GRANT SELECT,INSERT,UPDATE,DELETE ON ALL TABLES IN SCHEMA bulk_msg TO fphsrailsapp1;
   GRANT SELECT,USAGE ON ALL SEQUENCES IN SCHEMA bulk_msg TO fphsrailsapp1;
END IF;
