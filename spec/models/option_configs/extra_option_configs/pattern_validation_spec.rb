...
#   2. value_pattern DSL declares valid value shapes with type, allowed_keys, required_keys
#   3. validate_field_key_names reports warnings for unrecognized keys
#   4. validate_value_patterns reports errors for type mismatches, warnings for unknown hash keys,
#      errors for missing required keys
#   5. Default prepare_config injects _valid_fields from parent context
#   6. All field-keyed config classes declare appropriate patterns
