...
class CreateTestFileFieldRecsQoezsq < ActiveRecord::Migration[5.2]
  ...
  def change
    ...
    puts "Result of migration::::::::::::: #{table_name} > #{connection.table_exists?(table_name)}"
  end
end
