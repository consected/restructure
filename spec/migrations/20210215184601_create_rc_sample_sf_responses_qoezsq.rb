...
class CreateRcSampleSfResponsesQoezsq < ActiveRecord::Migration[5.2]
  include ActiveRecord::Migration::AppGenerator

  def change
    self.schema = 'test'
    self.table_name = 'rc_sample_sf_responses'
    self.fields = %i[record_id dob current_weight smoketime___pnfl smoketime___dnfl smoketime___anfl smoke_start
                     ...
                     test_timestamp q2_survey_timestamp redcap_survey_identifier]
