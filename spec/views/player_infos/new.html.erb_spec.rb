...
RSpec.describe "player_infos/new", type: :view do
  before(:each) do
    assign(:player_info, PlayerInfo.new(
      :master => nil,
      :first_name => "MyString",
      :last_name => "MyString",
  ...
  it "renders new player_info form" do
    render

    assert_select "form[action=?][method=?]", player_infos_path, "post" do
