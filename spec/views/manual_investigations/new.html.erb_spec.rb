...
RSpec.describe "manual_investigations/new", type: :view do
  before(:each) do
    assign(:manual_investigation, ManualInvestigation.new(
  ...
  it "renders new manual_investigation form" do
    render

    assert_select "form[action=?][method=?]", manual_investigations_path, "post" do
