...
RSpec.describe Admin::SubProcessesController, type: :controller do
  ...
  before :each do
    ...
    Classification::Protocol.create! name: "Q#{rand 1000}", position: rand(10000), disabled: false, current_admin: @admin
    @protocol = Classification::Protocol.create! name: "QA#{rand 1000}", position: rand(10000), disabled: false, current_admin: @admin
    Classification::Protocol.create! name: "QB#{rand 1000}", position: rand(10000), disabled: false, current_admin: @admin
  ...
  describe "Ensure authentication" do
    ...
    it "returns a result" do
      get :index, {protocol_id: @protocol_id}
  ...
  describe "GET #new" do
    ...
    it "assigns a new item as @var" do
      ...
      get :new, {protocol_id: @protocol_id}
  ...
  describe "GET #edit" do
    ...
    it "assigns the requested item as @var" do
      create_item
      get :edit, {:id => item_id, protocol_id: @protocol_id}
