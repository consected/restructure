...
describe "user and admin authentication" do
  ...
  it "redirects to user login page for all paths when not logged in" do
    ...
    admin_controllers = %w(admin/accuracy_scores admin/colleges admin/general_selections admin/item_flag_names admin/manage_users protocol_events protocols sub_processes admins admin/dynamic_models admin/sage_assignments admin/reports admin/external_links admin/activity_logs admin/external_identifiers admin/external_identifier_details admin/app_types admin/user_access_controls admin/app_configurations admin/message_notifications admin/message_templates admin/job_reviews admin/page_layouts)
